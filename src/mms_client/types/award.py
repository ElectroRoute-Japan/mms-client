...
class AwardQuery(Payload, tag="AwardResultsQuery"):
    ...
    # The name of the BSP participant that submitted the offer
...
class Award(Payload):
    ...
    # Name of the file containing the equipment point plan data
    equipment_point_plan_file: Optional[str] = baseload_file_name("EquipmentPointPlanFileName", True)
